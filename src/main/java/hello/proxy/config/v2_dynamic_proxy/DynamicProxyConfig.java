...
public class DynamicProxyConfig {
    ...
    public OrderControllerV1 orderController(LogTrace logTrace) {
        ...
        OrderControllerV1 proxyInstance = (OrderControllerV1) Proxy.newProxyInstance(OrderServiceV1.class.getClassLoader(),
                new Class[]{OrderControllerV1.class}, new LogTraceBasicHandler(logTrace, target));
    ...
    public OrderServiceV1 orderService(LogTrace logTrace) {
        ...
        OrderServiceV1 proxyInstance = (OrderServiceV1) Proxy.newProxyInstance(OrderServiceV1.class.getClassLoader(),
                new Class[]{OrderServiceV1.class}, new LogTraceBasicHandler(logTrace, target));
        return proxyInstance;
    }
    ...
    public OrderRepositoryV1 orderRepository(LogTrace logTrace) {
        ...
        OrderRepositoryV1 proxyInstance = (OrderRepositoryV1) Proxy.newProxyInstance(OrderRepositoryV1.class.getClassLoader(),
                new Class[]{OrderRepositoryV1.class}, new LogTraceBasicHandler(logTrace, target));
        return proxyInstance;
    }
    ...
    @Bean
    public InvocationHandler invocationHandler(LogTrace logTrace, Object target) {
        return new LogTraceBasicHandler(logTrace, target);
    }
}
